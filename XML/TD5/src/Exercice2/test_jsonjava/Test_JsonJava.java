package Exercice2.test_jsonjava;
...
public class Test_JsonJava {
    ...
    static public void once() throws IOException, JSONException {
        ...
        JSONTokener tokener = new JSONTokener(new FileReader("src\\Exercice2\\data\\jsonjava_once.json"));
    ...
    static public void array() throws IOException, JSONException {
        ...
        JSONTokener tokener = new org.json.JSONTokener(new FileReader("src\\Exercice2\\data\\jsonjava_array.json"));
